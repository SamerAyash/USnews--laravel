...
class NewsController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $data=$request->validate([
            ...
            'treeSelect.required'=>'News Types is required'
        ]);
        ...
        return redirect(route('profile'))->with('success','News published successfully');
    }

    public function edit($id){
            $news = news::findOrfail($id);

            return view('user.editPage',compact('news'));
           }
...
//            $news_types->update();
//        }
        return redirect(route('profile'))->with('success','News updated successfully');
